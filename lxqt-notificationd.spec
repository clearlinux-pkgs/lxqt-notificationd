...
Version  : 0.14.1
Release  : 4
URL      : https://github.com/lxqt/lxqt-notificationd/releases/download/0.14.1/lxqt-notificationd-0.14.1.tar.xz
Source0  : https://github.com/lxqt/lxqt-notificationd/releases/download/0.14.1/lxqt-notificationd-0.14.1.tar.xz
Source1  : https://github.com/lxqt/lxqt-notificationd/releases/download/0.14.1/lxqt-notificationd-0.14.1.tar.xz.asc
...
%prep
%setup -q -n lxqt-notificationd-0.14.1
cd %{_builddir}/lxqt-notificationd-0.14.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598295265
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-notificationd-0.14.1/LICENSE %{buildroot}/usr/share/package-licenses/lxqt-notificationd/7fab4cd4eb7f499d60fe183607f046484acd6e2d
pushd clr-build
%make_install
popd
